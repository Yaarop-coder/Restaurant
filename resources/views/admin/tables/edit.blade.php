                    ...
                    <form method="POST" action="{{ route('admin.tables.update', $table->id) }}">
                      ...
                      <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                          ...
                          class="block w-full bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('name') border-red-500 @enderror" />
                        </div>
                        @error('name')
